...
(function () {
    ...
    const BROKERS = [
        ...
        { id: 'revolut', name: 'Revolut', infoUrl: 'https://revolut.com/referral/?referral-code=lucasv5js!MAY2-26-AR-H1&geo-redirect', infoTooltip: 'App-based Bank, free plan has limits, paid plans offer more free trades, €1 flat fee per trade after allowance, FX up to 1%, FCA regulated.', maintenance: '€0-€450', stocksFees: '€1', etfFees: '€1', fxFee: '0.5% to 1%', minDeposit: '€0', withdrawal: '€0', inactivity: '€0', securitiesTransfer: 'With fee', regulator: 'FCA/CNMV/MiFID (Bank)', protection: '€100k' },
